...
edges_gray = cv2.Canny(image=img_gray, threshold1=a/3, threshold2=a/2)
edges_blur = cv2.Canny(image=img_blur, threshold1=a/3, threshold2=a/2)
...
img_canny_overlay = img.copy()
img_canny_overlay[edges_gray != 0] = [255, 0, 0]

imagens = [img, img_gray, img_blur, edges_gray, edges_blur, thresh, thresh_open, img_canny_overlay]
titulos = ['Original (RGB)', 'Cinza', 'Blur', 'Canny Gray', 'Canny Blur', 'Threshold', 'Open', 'Contornos Sobre Imagem']
